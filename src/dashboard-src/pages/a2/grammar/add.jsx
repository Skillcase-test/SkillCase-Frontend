...
import { uploadA2Grammar, getA2Template } from "../../../../api/a2Api";
export default function A2GrammarAdd() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await uploadA2Grammar(formData);
  ...
  const handleDownloadTemplate = async () => {
    try {
      const res = await getA2Template("grammar");
      ...
      a.href = url;
      a.download = "a2_grammar_template.json";
      a.click();
    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
      <div className="mb-8">
        <h1 className="text-2xl md:text-3xl text-gray-800 font-bold">
          Add A2 Grammar Topic
        </h1>
        <p className="text-sm text-gray-600 mt-1">
          Upload JSON files with grammar explanations and questions
        </p>
      </div>
      <div className="bg-white shadow-xs rounded-xl">
        <div className="p-6 space-y-6">
          ...
          <button
            ...
            className="w-full bg-blue-500 text-white px-6 py-3 rounded-lg hover:bg-blue-600 font-semibold flex items-center justify-center gap-2 disabled:opacity-50"
          >
            {isUploading ? (
              <>
        ...
        <div className="flex gap-3">
          ...
          <div className="text-sm text-blue-700">
            ...
            <ul className="list-disc list-inside space-y-1 text-blue-600">
              ...
              <li>explanation: string (grammar explanation)</li>
              <li>
                questions: array with types: mcq_single, mcq_multi, fill_typing,
                fill_options, true_false, sentence_ordering,
                sentence_correction, matching
              </li>
            </ul>
          </div>
        </div>
