...
import { uploadB2ExamPaper } from "../../../../api/b2Api";
import toast, { Toaster } from "react-hot-toast";

export default function B2ExamsAdd() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await uploadB2ExamPaper(formData);
      if (res.data?.success) {
        toast.success("Successfully uploaded B2 exam paper!");
