...
export default function A1FlashcardManage() {
  ...
  const fetchChapters = async () => {
    ...
    try {
      const res = await getA1Chapters("flashcard");
  ...
  const handleDelete = async (chapter) => {
    ...
    try {
      await deleteA1Chapter("flashcard", chapter.id);
  ...
  const handleSaveOrder = async () => {
    ...
    try {
      ...
      await reorderA1Chapters("flashcard", orderedIds);
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h1 className="text-2xl md:text-3xl text-gray-800 font-bold">
            Manage A1 Flashcard Chapters
          </h1>
          <p className="text-sm text-gray-600 mt-1">
            Reorder or delete A1 flashcard chapters
          </p>
        </div>
        <button
        ...
        <div className="bg-white shadow-xs rounded-xl">
          <div className="px-5 py-4 border-b border-[#E5E7EB] flex justify-between items-center">
            <h2 className="font-semibold text-gray-800">
              A1 Flashcard Chapters ({chapters.length})
            </h2>
            {hasChanges && (
              <button
      ...
      <div className="mt-6 bg-amber-50 border border-amber-200 rounded-xl p-4">
        <div className="flex gap-3">
          ...
          <div className="text-sm text-amber-700">
            ...
            <p>
              Reordering changes learner chapter sequence. Click Save Order
              after drag-and-drop.
            </p>
          </div>
        </div>
