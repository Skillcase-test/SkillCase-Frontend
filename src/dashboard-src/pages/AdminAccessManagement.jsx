...
const MODULE_OPTIONS = [
  ...
  { key: "b2_content", label: "B2" },
  { key: "video_course_content", label: "Video Courses" },
...
const FULL_ACCESS_ONLY_MODULES = {
  ...
  b2_content: { grantAction: "manage" },
  video_course_content: { grantAction: "manage" },
  notes_content: { grantAction: "manage" },
