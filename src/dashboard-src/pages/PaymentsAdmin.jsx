...
import { AuthGateCard } from "../payments-admin/components/AuthGateCard";
import {
  EmptyState,
  StatCard,
  TableSkeleton,
...
export default function PaymentsAdmin() {
  ...
  if (!state.authorized)
    return (
      <AuthGateCard
        ...
        handleStepUp={actions.handleStepUp}
        error={state.error}
      />
    );
  ...
  const searchable = {
    ...
    payments: [
      ...
      "Search candidate/phone/payment/status",
    ],
    rawlogs: [
      state.rawSearch,
      state.setRawSearch,
          ...
          <TabContent
            ...
            props={{
              ...
              handleGenerateAndSendInvoice:
                actions.handleGenerateAndSendInvoice,
