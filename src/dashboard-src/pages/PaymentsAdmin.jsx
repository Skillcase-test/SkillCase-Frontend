            ...
            {isFuture ? (
              ...
              <TabContent
                ...
                props={{
                  ...
                  allProfessionFilter: state.allProfessionFilter,
                  setAllProfessionFilter: state.setAllProfessionFilter,
                  monthProfessionFilter: state.monthProfessionFilter,
                  setMonthProfessionFilter: state.setMonthProfessionFilter,
                  ...
                  handleRevertToRecruitment: actions.handleRevertToRecruitment,
                  ...
                  handleBulkGenerateInvoices: actions.handleBulkGenerateInvoices,
                  handleSendInvoice: actions.handleSendInvoice,
                  handleBulkSendInvoices: actions.handleBulkSendInvoices,
