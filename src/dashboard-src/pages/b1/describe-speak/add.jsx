...
import { uploadB1DescribeSpeak } from "../../../../api/b1Api";
import toast, { Toaster } from "react-hot-toast";

export default function B1DescribeSpeakAdd() {
  ...
  const handleSubmit = async (e) => {
    ...
    setIsUploading(true);
    setUploadStatus("uploading:Uploading describe & speak content...");
    ...
    try {
      ...
      const res = await uploadB1DescribeSpeak(formData);
      if (res.data?.success) {
        toast.success(`Successfully uploaded describe & speak content!`);
    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
      ...
      <div className="mb-8">
        <h1 className="text-2xl md:text-3xl text-gray-800 font-bold">
          Add B1 Describe & Speak Content
        </h1>
        <p className="text-sm text-gray-600 mt-1">
          Upload JSON configuration file along with a ZIP of images or loose image files.
        </p>
      </div>
