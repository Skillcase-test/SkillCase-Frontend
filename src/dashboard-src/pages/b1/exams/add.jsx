...
import { uploadB1ExamPaper } from "../../../../api/b1Api";
import toast, { Toaster } from "react-hot-toast";

export default function B1ExamsAdd() {
  ...
  const handleZipChange = (e) => {
    ...
    setUploadStatus("error:Please select a valid ZIP archive containing media files");
    setZipFile(null);
  };
  ...
  const handleSubmit = async (e) => {
    ...
    setIsUploading(true);
    setUploadStatus("uploading:Uploading exam paper content...");
    ...
    try {
      ...
      const res = await uploadB1ExamPaper(formData);
      if (res.data?.success) {
        toast.success(`Successfully uploaded exam paper!`);
    ...
    <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
      ...
      <div className="mb-8">
        ...
        <p className="text-sm text-gray-600 mt-1">
          Upload JSON configuration file along with a ZIP of media assets (images and audio).
        </p>
      </div>
