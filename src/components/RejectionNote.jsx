...
const RejectionNote = ({
  ...
  return (
    <motion.div
      ...
      className="relative w-full p-4 bg-amber-50 rounded-2xl border border-amber-200 shadow-[0_4px_16px_rgba(217,119,6,0.08)] flex flex-col gap-3 text-left overflow-hidden text-amber-950"
    >
      {/* Subtle paper tape accent at the top center */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-14 h-2 bg-amber-200/60 rounded-b-sm pointer-events-none" />
