...
const LoginSignupPage = () => {
  ...
  const handleAuth = async (e) => {
    ...
    try {
      ...
      // Auto-redirect after success (no alert)
      navigate("/");
    } catch (err) {
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-6 sm:p-8 md:p-10 border border-slate-100">
          ...
          <div className="space-y-6">
            ...
            <button
              onClick={handleAuth}
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 text-white font-semibold py-3 sm:py-4 rounded-xl transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2 group cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isLoading ? (
                <>
                  <svg
