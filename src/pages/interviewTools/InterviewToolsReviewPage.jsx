          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              ...
              <div className="mt-4 flex items-center gap-2">
                 <span className="text-[10px] uppercase tracking-widest font-bold text-slate-400 ml-1">Calculated Average:</span>
                 <span className="bg-slate-100 text-slate-700 font-bold px-2 py-0.5 rounded text-xs">{calculatedAverage || "-"}</span>
              </div>
              <input
                type="number"
                min="1"
              ...
              <div className="space-y-2">
                {answerList.map((item, index) => (
                  ...
                  >
                    ...
                    <span className={`px-2 py-0.5 rounded text-xs ${activeIndex === index ? 'bg-white/20' : 'bg-white border border-slate-200'}`}>
                      {item.admin_score || "-"}
                    </span>
                  </button>
                ))}
