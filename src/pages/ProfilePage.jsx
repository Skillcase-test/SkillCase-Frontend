...
export default function ProfilePage() {
    ...
    return (
      <div className="min-h-screen bg-black/5 pb-12" aria-label="Loading profile">
        ...
        <div className="max-w-xl mx-auto px-4 pt-5 flex flex-col gap-6">
          ...
          <div className="bg-white rounded-2xl p-5 shadow-sm border border-slate-100 flex flex-col gap-3 animate-pulse">
            <div className="h-4 w-32 bg-slate-200 rounded" />
            <div className="h-10 w-full bg-slate-100 rounded-xl" />
          </div>

          {/* Menu Items List */}
          <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100 flex flex-col gap-3 animate-pulse">
  ...
  return (
    <div className="min-h-screen bg-black/5 pb-12">
      {/* Toast Notification */}
      {toast.show && (
        <div
      ...
      {uploadModal.open && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/50 backdrop-blur-xs p-4 select-none ">
