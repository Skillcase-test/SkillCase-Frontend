...
//     try {
//       // Generate unique nonce for abuse prevention
...
//       // Redirect to Thank You page with nonce
//       setTimeout(() => {
//         setIsSubmitting(false);
//         setShowModal(false);
//         navigate(`/thank-you?nonce=${nonce}`); // Redirect with nonce
//       }, 2000);
//     } catch (error) {
//       console.error("Error:", error);

//       // Generate nonce even on error
//       const nonce = `${Date.now()}-${Math.random().toString(36).substr(2, 9)}`;
//       sessionStorage.setItem("thankYouNonce", nonce);

//       // Still submit to Bigin even if backend fails
//       formRef.current.submit();
//       setTimeout(() => {
//         setIsSubmitting(false);
//         setShowModal(false);
//         navigate(`/thank-you?nonce=${nonce}`);
//       }, 2000);
//     }
//   };
