...
export default function ExamCongratulations() {
  ...
  const handleReattempt = async () => {
    ...
    setResetError(false);
    try {
      await resetB2ExamSubmission(submissionData.id);
  ...
  const overallTryToImprove =
    ...
    "Work on listening comprehension details and expand B2 vocabulary ranges.";

  // Remove hardcoded "TELC" fallback — exam_type is always present via getB2ExamSubmissionStatus JOIN
